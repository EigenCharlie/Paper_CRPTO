...
**Price of robustness**
:   Campo congelado `price_of_robustness`, definido **con signo** como el retorno esperado (point-PD) de la baseline no-robusta menos el de la política robusta. Para el champion vale `−$14 465,69` (`−10,56 %`); el signo negativo indica que la robustez *mejora* el retorno esperado frente a la baseline (ver @sec-crpto-results). No confundir con el `Γ` de Bertsimas-Sim ni con `Γ_CP`.
