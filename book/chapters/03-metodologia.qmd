...
El ECE final del champion (`0.0062`) es 10× mejor que el del modelo sin calibrar (~0.07 estimado), confirmando que el resultado operacional no es accidental — la calibración sí mejora la fidelidad probabilística por bin, no sólo el rechazo formal de tests con $n$ grande (ver `tbl-crpto-calibration-tests`).
:::
