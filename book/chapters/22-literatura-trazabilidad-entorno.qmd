...
[@barcena2024] aplicaron ML con riesgos competitivos para estimar PD lifetime bajo IFRS 9. [@sicr2025] compararon definiciones de eventos SICR, y [@ifrsboard2024] publico un análisis de retroalimentacion sobre las dificultades prácticas de los triggers actuales. [@botha2026] abordaron la modelizacion de la estructura temporal de default bajo IFRS 9, y [@chen2024creditrisk] ofrece un tratamiento comprehensivo de modelizacion práctica de riesgo de crédito. [@ecb2024] documenta las expectativas supervisoras del BCE sobre *overlays* y mejoras de modelos. En el ambito de scoring, [@lessmann2015] y [@ayari2026] proporcionan benchmarks sistematicos de algoritmos de clasificación para crédito.
