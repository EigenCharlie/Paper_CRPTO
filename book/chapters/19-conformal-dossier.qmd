...
### Diagnóstico Estadístico de Cobertura

Antes de leer los resultados de los tests, conviene establecer el marco correcto. Estos tests son diagnósticos, no criterios de aceptación del pipeline. El sistema **sobre-cubre**: la tasa de violación observada queda por debajo de la nominal, lo que indica conservadurismo, no subcobertura. Con $n = 276{,}869$, los p-valores tienen potencia suficiente para rechazar diferencias pequeñas. El gate editorial del paper se decide con cobertura mínima, ancho, cobertura por grupo, alertas, Winkler e independencia/materialidad.
...
::: {.callout-warning}
## P-values Rechazados — No Son Gate del Paper
