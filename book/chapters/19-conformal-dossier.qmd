...
## Fuente curada: `book/chapters/07-conformal/index.qmd`
...
::: {.column-page}
![Cobertura conformal observada por grade del portafolio, usada para verificar validez útil a nivel de negocio.](../assets/figures/editorial/conformal_coverage_by_grade.png)
:::

::: {.column-page}
![Trade-off entre cobertura objetivo e intervalo promedio para variantes global y Mondrian del pipeline.](../assets/figures/editorial/conformal_width_vs_target.png)
:::
...
<div class="capítulo-landing-grid">
  <div class="capítulo-card"><h4><a href="07a-split-conformal-basics.html">24. Split Conformal</a></h4><p>Garantía finita, API MAPIE y scores de no conformidad.</p></div>
  <div class="capítulo-card"><h4><a href="07b-mondrian-group-conditional.html">25. Mondrian</a></h4><p>Cobertura por grade y validez útil por grupo.</p></div>
  <div class="capítulo-card"><h4><a href="07c-cqr-variants-benchmark.html">26. Variantes</a></h4><p>Benchmark de variantes, selección y trade-offs.</p></div>
  <div class="capítulo-card"><h4><a href="07d-backtest-monitoring.html">27. Monitoreo</a></h4><p>Backtest mensual, alertas y lectura prudencial.</p></div>
  <div class="capítulo-card"><h4><a href="07e-lgd-ead-conformal.html">28. LGD / EAD</a></h4><p>Extensión conformal fuera de PD y promoción del carril.</p></div>
</div>
```
...
## Fuente curada: `book/chapters/07-conformal/07a-split-conformal-basics.qmd`
...
## Fuente curada: `book/chapters/07-conformal/07b-mondrian-group-conditional.qmd`
...
## Fuente curada: `book/chapters/07-conformal/07c-cqr-variants-benchmark.qmd`
...
::: {.column-page}
![Distribución del ancho de intervalos en variantes conformales, útil para comparar eficiencia más allá de la cobertura agregada.](../assets/figures/notebooks/interval_width_distribution.png)
:::
...
## Fuente curada: `book/chapters/07-conformal/07d-backtest-monitoring.qmd`
...
## Fuente curada: `book/chapters/13-advanced-topics/13a-uncertainty-baselines.qmd`
...
::: {.column-page}
![Trade-off entre cobertura, anchura y cobertura mínima por grupo para los baselines de incertidumbre evaluados.](../assets/figures/editorial/uncertainty_baselines_tradeoff.png)
:::
...
![Comparación publication-quality de baselines de incertidumbre: CP Mondrian vs BMA vs Bootstrap, evaluados sobre 276K préstamos OOT.](../assets/figures/publication/crpto_fig7_uncertainty_baselines.png)

## Fuente curada: `book/chapters/13-advanced-topics/13b-alpha-sweep-pareto.qmd`
...
::: {.column-page}
![Frontera alpha-cobertura-anchura para los barridos global y Mondrian del parámetro conformal.](../assets/figures/editorial/alpha_pareto_frontier.png)
:::

::: {.column-page}
![Cantidad de préstamos elegibles bajo la policy PD_high < 0.10 al variar alpha para la variante Mondrian.](../assets/figures/editorial/alpha_eligible_loans.png)
:::
...
![Frontera Pareto de alpha sweep: trade-off entre nivel de confianza conformal y KPIs de portafolio, formato de publicación.](../assets/figures/publication/crpto_fig8_alpha_pareto.png)
