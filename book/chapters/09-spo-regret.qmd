...
### Agenda: el carril DFL formal con PyEPO 1.3.7

Esta sección es **agenda, no resultado**. El comparador SPO+ que el paper cita ya
es defendible con los artefactos congelados; lo que sigue es la frontera de
trabajo futuro que `docs/research/crpto_pyepo_dfl_intake_2026-05-26.md` deja
documentada, sin re-correr nada ni tocar el champion.
...
La regla de parada es la misma del intake: una corrida de reproducción SPO+ y un
comparador RFYL sobre las mismas instancias; si no cambian un claim del
manuscrito ni producen una tabla de comparación más limpia, el carril se detiene.
Mientras tanto, ningún número de PyEPO entra al cuerpo del paper hasta que exista
una corrida real registrada.
