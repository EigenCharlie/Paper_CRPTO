...
|---|---|---|
| Champion oficial = economic champion | `models/final_project_promotion.json`, `models/champion_portfolio_policy.json` | `tests/test_docs/test_crpto_final_sync.py` |
...
| Journal package A12--A18 | `crpto_tableA12_tail_risk_oce_cvar.csv`--`crpto_tableA18_robust_region_policy_family.csv`, `crpto_fig12`--`crpto_fig14` | `test_crpto_journal_package_artifacts_exist` |
