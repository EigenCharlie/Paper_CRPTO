...
| Journal package A12--A19 | `crpto_tableA12_tail_risk_oce_cvar.csv`--`crpto_tableA19_regret_auditability_frontier.csv`, `crpto_fig12`--`crpto_fig15` | `test_crpto_journal_package_artifacts_exist` |
