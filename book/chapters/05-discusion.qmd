...
| Body point IJDS pool93 `$184,832.48`, `8/8` alpha grid | `pool93_ijds_consolidated_governance.json` (`selected_candidates.paper_body`), tablas A35--A39 | `tests/test_pool93_body_claim_sync.py` |
