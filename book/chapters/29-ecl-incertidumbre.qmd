...
::: {.callout-warning}
## Alcance: teaser del segundo paper

Este capítulo es material exploratorio orientado a un segundo paper (ECL/IFRS9
bajo incertidumbre conformal). **No forma parte de los claims del manuscrito
CRPTO enviado a IJDS**: la provisión ECL mostrada es evidencia narrativa
derivada de artefactos congelados, no una política contractual ni un resultado
del paper.
:::
