...
## Fuente curada: `book/chapters/06-pd-modeling/06a-logistic-regression-baseline.qmd`
...
## Fuente curada: `book/chapters/06-pd-modeling/06b-catboost-tuned.qmd`
...
## Fuente curada: `book/chapters/06-pd-modeling/06c-calibration-selection.qmd`
...
![Curvas de calibración (reliability diagrams) de los métodos candidatos evaluados sobre el conjunto de test OOT.](../assets/figures/notebooks/calibration_curves.png)
...
## Fuente curada: `book/chapters/06-pd-modeling/06d-model-comparison-champion.qmd`
...
::: {.column-page}
![Curvas ROC de los modelos PD principales evaluados en el proyecto.](../assets/figures/editorial/pd_roc_curve.png)
:::

::: {.column-page}
![Diagrama de confiabilidad del champion y sus comparadores, usado para justificar la promoción del calibrador Venn-Abers.](../assets/figures/editorial/pd_reliability_curve.png)
:::
...
::: {.column-page}
![Curva Precision-Recall del champion y sus comparadores, relevante por el desbalance de clases del problema.](../assets/figures/editorial/pd_pr_curve.png)
:::
...
![Curvas ROC comparativas de los modelos evaluados sobre el test set OOT (276,869 préstamos).](../assets/figures/notebooks/roc_curves.png)
