...
- **SPO+** entrena end-to-end para minimizar regret de decisión. En este proyecto, el cierre curado PyEPO 1.3.7 logra una reducción de regret del `48.51%` sobre el two-stage clásico (5 seeds, 1,000 observaciones pareadas, Wilcoxon `p = 3.80e-163`). Su fortaleza es la eficiencia decisional.
