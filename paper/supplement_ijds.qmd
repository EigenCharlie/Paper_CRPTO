...
## B.1 Primary learner and four predeclared coverage controls
...
month-end of last payment.
Before evaluation, the sensitivity protocol fixed alternative lags of 0, 3, 6,
8, and 12 months and required more than 99% retention in every fitting month.
...
: S7A predeclared label-lag sensitivity. The W7--W8 threshold crossing persists for every lag satisfying the retention stop rule. {#tbl-s-label-lag}
...
| Label-lag sensitivity | The W7--W8 crossing persists at every lag passing the 99% retention rule | Invariance to arbitrarily delayed labels or a causal explanation |
...
point-in-time extract. The six-month Charged Off availability delay is a
modeling assumption rather than an observed operational charge-off date; the
predeclared lag analysis supports only the specifications satisfying strict
greater-than-99% fitting-label retention. Delinquency recency is structurally nullable and
