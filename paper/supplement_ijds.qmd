...
details, robustness and external-replication tables A3--A38, reproducibility
...
and A37--A38 add pool93-specific tail-risk and cluster-bound repricing from the
same selected allocation.
:::
...
weights. Bootstrap resampling under the final pool93 allocation remains a future
diagnostic, not a blocker for the submitted claim.
...
frontier. The consolidated artifact deduplicates 51,678 raw rows into 50,010
...
the regenerated pool93 cluster-bound sensitivity. A38 confirms that the
...
Tables A12--A38 answer likely reviewer questions that are too detailed for the
...
tail-risk repricing, and A38 is the pool93 body-point cluster-bound audit. A12--A34
...
| The supplement strengthens interpretation without moving the body claim. | A20--A34 challenger, dependence, tail-risk, multi-distribution, online, and external-replication diagnostics; A35 is the active pool93 frontier; A36--A38 are selected-allocation pool93 audits. | Journal robustness tables, Figures 15--25, A35--A38. | Scope caveats in each table; A37/A38 are pool93 risk-profile audits, not hidden champion selectors. |
...
A19--A38 should be read as literature-aligned stress evidence. A19 places CRPTO
...
pool93 body claim; A37--A38 regenerate the selected pool93 allocation's
tail-risk and concentration profile; and A23--A24 show where multi-distribution and online conformal work
...
| Online supplement | `paper/supplement_ijds.qmd` | Proofs, A3--A38, MRM/fairness, reproducibility. |
