...
details, robustness tables A3--A19, reproducibility commands, model-risk
...
Tables A12--A19 answer likely reviewer questions that are too detailed for the
25-page body. They are diagnostic by design, except A19 also supports the body
framing around regret-auditability.
...
| Online supplement | `paper/supplement_ijds.qmd` | Proofs, A3--A19, MRM/fairness, reproducibility. |
