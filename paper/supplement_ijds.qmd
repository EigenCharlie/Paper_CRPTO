...
inequality yields, for every $t > 0$,
...
variants. At `alpha = 0.01`, weak-variance Cantelli gives `t = 0.0661`, Bennett
gives `t = 0.0722`, and Bernstein/Freedman give `t = 0.0852` under the weaker
weighted-validity variance proxy; the stronger individual-alpha variance mode is
sharper but requires an assumption we do not assert in the theorem.
