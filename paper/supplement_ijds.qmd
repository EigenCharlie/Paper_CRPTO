...
: Table S7C. Complete two-origin CatBoost coverage census. The later family is a retrospective recurrence, not an independent replication.
...
![Figure S1. Direction of the exact development-admissible comparator envelope. A minus or plus denotes a sign-robust guardrail-minus-point envelope; zero denotes an envelope containing zero. Default contains zero in all 72 cells.](../reports/crpto/figures/crpto_ijds_v4_fig3_envelopes.png){width=96%}
...
2. immutable, hash-described outcome-free and evaluated roots tracked by 33
