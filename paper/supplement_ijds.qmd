...
summary and execution receipt before writing S1--S7 and the three manuscript
figures. The historical compact-v7 A35--A40 bundle remains immutable provenance
but is not evidence for any active claim.
...
- `crpto_ijds_ms_table3_primary_contrast`;
- `crpto_ijds_ms_tableS1_selection_grid` through `tableS7_monthly_contrast`;
- `crpto_ijds_ms_fig1_timeline`, `fig2_monthly`, and `fig3_transport` in PNG
  and PDF; and
