...
**PD stability diagnostics.** Two run-tag diagnostics (`ijds-sensitivity-2026-06-14`,
run in isolation and separate from the frozen champion) support distributing a frozen
PD binary rather than a "retrain it yourself" recipe. Retraining the champion
...
out-of-time regime. Both confirm stability rather than overturning the headline, and
are reported as diagnostics, not a new champion.
