...
| Objective matching changes direction | .25 payoff +USD 5,603.66; .50 payoff hull [-82,616, -27,958]; .75 hull [-158,470, 72,565] | Direction changes with the common objective coordinate | Promotion of favorable .25 or adverse .50 after outcomes |
| The .25 contrast is repeated, not replicated | 44 loan-month positions; USD 155,937.27 one-way turnover; four active months in every window | Report the allocation contrast once | Eight independent confirmations |
| Normalized-score tracks are adverse but not opportunity matched | All 24 payoff bounds lower; gamma one has USD 28,263--557,294 more plug-in objective | Relative score relaxation is affine-invariant and answers a different question | Causal harm or equal opportunity cost |
...
- objective-matched `.25`: `44` changed loan-month positions, USD `155,937.27`
  one-way turnover, USD `5,603.66` higher payoff, and `-0.00679` pp
  default/miscoverage;
- objective-matched `.50` payoff hull: `[-82,616, -27,958]`; `.75` payoff hull:
  `[-158,470, 72,565]`;
- normalized-score tracks: payoff lower and default/miscoverage higher in all
  `24` window cells, without equal plug-in opportunity cost;
...
- a selected learner, taxonomy, residual window, gamma, ruler, coordinate,
...
- eight confirmations for the repeated objective-matched `.25` contrast;
- a continuous two-ruler frontier or equal-opportunity-cost interpretation of
  normalized-score coordinates;
