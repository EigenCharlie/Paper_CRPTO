...
|---|---|---|---|
| Lending Club Loan Data 2007-2020Q3 | Active 540,121-row maturity-safe credit panel. | Kaggle mirrors and Figshare mirrors exist for `Loan_status_2007-2020Q3.csv`; the project uses a local raw CSV under `data/raw/`, ignored by Git and referenced by DVC metadata. | Provide acquisition instructions, expected size/SHA-256, schema/cleaning code, and both active DVC pointers. Do not commit or rehost the 1.7 GB raw CSV in Git. |
