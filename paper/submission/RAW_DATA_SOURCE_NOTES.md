...
|---|---|---|---|
| Lending Club Loan Data 2007-2020Q3 | Common 465,117-loan OOT panel; early/late designs retain 540,121/625,576 rows. | Kaggle mirrors and Figshare mirrors exist for `Loan_status_2007-2020Q3.csv`; the project uses a local raw CSV under `data/raw/`, ignored by Git and referenced by DVC metadata. | Provide acquisition instructions, expected size/SHA-256, schema/cleaning code, and all six active DVC pointers. Do not commit or rehost the 1.7 GB raw CSV in Git. |
