...
|---|---|---|---|
| Lending Club Loan Data 2007-2020Q3 | One 640,543-loan design universe; 376,890 primary OOT and 88,227 extension candidates. | Kaggle mirrors and Figshare mirrors exist for `Loan_status_2007-2020Q3.csv`; the project uses a local raw CSV under `data/raw/`, ignored by Git and referenced by DVC metadata. | Provide acquisition instructions, expected size/SHA-256, schema/cleaning code, and all eight active V4/two-ruler DVC pointers. Do not commit or rehost the 1.7 GB raw CSV in Git. |
