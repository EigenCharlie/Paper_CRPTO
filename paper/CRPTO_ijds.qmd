...
external economic replications on Prosper and Freddie/Mendeley to separate the
methodological claim from the idiosyncrasies of one P2P panel. The key claim is
...
not exact conditional coverage for every borrower profile. Finally, this is not
