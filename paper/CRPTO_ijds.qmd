...
leaderboard-oriented: CRPTO is an auditable bridge from conformal credit-risk
uncertainty to a frozen robust funding decision. Third, it provides an
...
`0.7124`, Brier score `0.1546`, and ECE near `0.0064`. The conformal layer
...
new external cohorts. Its conformal guarantee is marginal or partitioned by the
chosen Mondrian design, not exact conditional coverage for every borrower
profile. It is also not an online deployment study: there are no new
post-2020 retail originations, no live monitoring loop, and no end-to-end
utility-directed conformal learner replacing the frozen PD artifact.
