...
supplement carries A3--A36, the conformal finalist ablation, funded-set loan
...
that depend on funded-loan row-level composition or tail-risk repricing are
labeled as diagnostic unless regenerated from the promoted pool93 allocation.
...
CVaR/OCE tail repricing is retained in the online supplement as diagnostic
machinery and should be regenerated from the promoted pool93 row-level
allocation before it is used as a pool93-specific tail claim.
