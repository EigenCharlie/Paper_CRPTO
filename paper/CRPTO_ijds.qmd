...
![CRPTO's central move is operational rather than decorative: calibrated PD intervals become robust optimization inputs, and the promoted funding policy is then audited against exact funded-set risk controls.](../reports/crpto/figures/crpto_fig12_crpto_conceptual_pipeline.png){#fig-crpto-pipeline width="90%"}
