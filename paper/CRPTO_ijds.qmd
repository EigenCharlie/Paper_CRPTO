...
the present contribution. The claim here is a reproducible two-stage bridge,
not a new online or end-to-end training algorithm.

<!-- TODO(manuscript): tighten this review to the final IJDS page budget after the
official template is installed. -->
...
<!-- TODO(manuscript): after the body is complete, convert this source into the
official IJDS LaTeX template and decide how the companion is disclosed under
