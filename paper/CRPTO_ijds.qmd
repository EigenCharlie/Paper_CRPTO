...
conformal robust credit-portfolio decision built from frozen calibrated PD
artifacts.
...
from frozen outputs rather than manually transcribed summaries, and it
...
overclaiming. CRPTO uses the first two levels as evidence, reports the next two
as diagnostics, and leaves online/live control for a new protocol.
...
| Weighted/localized coverage | Coverage under weights, local neighborhoods, or selected groups. | Diagnostic motivation for A23. |
