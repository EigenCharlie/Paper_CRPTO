...
abstract: |
  ...
  ruler, coordinate, or policy is selected. CRPTO contributes an identification
  audit: binary conformal geometry is prevalence-sensitive, coverage does not
  transport here, and portfolio direction depends on comparator stringency.
keywords:
...
exact point-cap support do not form a continuous joint frontier. The inspected
archive is not a pristine lockbox or preregistration.
...
and timing audits, solver checks, versioned DVC pointers, and the environment
lock. The evidence builder verifies hashes and scientific invariants before
producing twelve tables and three figures in PNG and PDF byte-identically.
