...
The SPO+ comparator makes the trade-off sharp. In the paired regret experiment,
SPO+ reduces mean regret from `0.4259` to `0.2168`, a `49.1%` improvement over
the two-stage baseline. The CRPTO robust point has higher decision regret
...
|---|---:|---:|---:|
| Two-stage baseline | `0.4259` | `0.0%` | `0/3` |
| SPO+ | `0.2168` | `49.1% lower` | `0/3` |
