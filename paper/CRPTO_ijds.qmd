...
data, calibrated predictive models, robust funding decisions, and
...
portfolio-level statement. The empirical exact audit reported in this
...
section; the certificate is the empirical audit that connects that assumption to
