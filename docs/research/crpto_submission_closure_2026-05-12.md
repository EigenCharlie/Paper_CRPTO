...
- Prosper/Freddie static external replication with Freddie all-candidate LP
...
| Multidataset external replication | `reports/crpto/tables/crpto_tableA25_external_replication_gate.csv`--`crpto_tableA33_freddie_segment_sensitivity.csv` | Prosper/Freddie transfer evidence and Freddie all-candidate certificate; no Lending Club champion change. |
