...
> (`crpto_mini_book_expansion_audit_2026-05-21`). In this child project the parent
...
| Negative-results registry (from regret-auditability closure + Paper 4) | `book/chapters/07-apendice-robustez.qmd` / `23` |
| Figure/table decision log (3 figures, 2-3 tables IJDS body) | `book/chapters/06-blueprint-manuscrito.qmd` |

## Stop Rule

Do not reopen champion selection or Paper 4 promotion. A parked item may enter the
