...
- Added a manuscript blueprint with target venue, abstract, claims C1--C7,
  ...
  location map.
- Added a journal appendix page that now renders A12--A34 plus the journal figure set:
...
- A12--A34 robustness evidence that can be pushed to appendix instead of
...
- the manuscript blueprint contains venue, claims C1--C7 and final table/figure
  plan;
- the appendix page references A12--A34 and the new figures;
