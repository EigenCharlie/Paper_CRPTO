...
| A20--A24 strengthen the journal story without promoting a new champion. | Supplement. | Tail, satisficing, cluster, CVaR/OCE, MDCP/ACI diagnostics. | Keep challenger diagnostics distinct from official policy. |
