...
current IJDS package. It is implemented as A25--A34 using curated Prosper and
Freddie/Mendeley summaries plus price-of-robustness scaling. Future work now
refers to prospective/live external validation or new datasets beyond those
static replications.
...
| Multi-dataset credit replication | Implemented in IJDS supplement | A25--A34 + Fig 22--25 | Static Prosper/Freddie replication plus price-of-robustness scaling; live/prospective validation remains future work. |
...
| P1 | Implemented | Synthetic/period shift evidence | robustness | A4, A6, A7, A8, A11 | No for current paper | strengthens current paper | complements the static external replication A25--A34 |
...
| P1/J | Implemented | Journal appendix A12--A34 | appendix evidence | `07-apendice-robustez.qmd` | No | complements paper | use as appendix package, not new champion evidence |
...
evidence, the A3--A34 supplement, the regret-auditability frontier, the static
...
| Appendix A12--A34 | `book/chapters/07-apendice-robustez.qmd` | renders tail risk, satisficing, dependency, stress, bootstrap, LGD/cap, robust-region, regret-auditability, tail-satisficing, cluster-bound, tail-constrained, multi-distribution, online, external-replication and price-of-robustness evidence | appendix material unless a journal asks for more body evidence |
...
references `[1]`, `[2]`, ... and the A12--A34 appendix package that can later be
