...
- `feature_config.yml` plus `feature_config.parquet` are the live champion
  feature contract as of the 2026-06-13 run-tag-approved cleanup; the legacy
  `feature_config.pkl` was removed from the DVC stage and manifest.
