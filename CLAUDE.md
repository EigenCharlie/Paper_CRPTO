...
- `UV_PROJECT_ENVIRONMENT=.venv-wsl` — recomendado si se trabaja desde WSL para no pisar la `.venv` de Windows.
- `QUARTO_PYTHON` — **NO setear manualmente en Windows**; `uv run -- quarto` lo resuelve.
